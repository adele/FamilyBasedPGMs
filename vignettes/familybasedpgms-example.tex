...
\CommentTok{#> IGRAPH 9468813 UN-- 3 3 -- }
\CommentTok{#> + attr: name (v/c)}
\CommentTok{#> + edges from 9468813 (vertex names):}
...
\CommentTok{#> IGRAPH 6bbe0a4 UN-- 3 3 -- }
\CommentTok{#> + attr: name (v/c)}
\CommentTok{#> + edges from 6bbe0a4 (vertex names):}
\CommentTok{#> [1] X--Y X--Z Y--Z}
...
\CommentTok{#> IGRAPH 1aeada3 UN-- 3 3 -- }
\CommentTok{#> + attr: name (v/c)}
\CommentTok{#> + edges from 1aeada3 (vertex names):}
\CommentTok{#> [1] X--Y X--Z Y--Z}
...
\NormalTok{igraph}\OperatorTok{::}\KeywordTok{plot.igraph}\NormalTok{(igraph}\OperatorTok{::}\KeywordTok{graph.adjacency}\NormalTok{(adjM_g), }
                    \DataTypeTok{vertex.size=}\DecValTok{30}\NormalTok{, }\DataTypeTok{vertex.color=}\StringTok{"lightblue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{igraph}\OperatorTok{::}\KeywordTok{plot.igraph}\NormalTok{(igraph}\OperatorTok{::}\KeywordTok{graph.adjacency}\NormalTok{(adjM_e),}
                    \DataTypeTok{vertex.size=}\DecValTok{30}\NormalTok{, }\DataTypeTok{vertex.color=}\StringTok{"lightblue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{table}[!htbp] \centering 
  \caption{Partial Correlation Results} 
  \label{PCpcor} 
\begin{tabular}{@{\extracolsep{-5pt}} cccccccccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
 & x & y & S & pcort & pcort\_p.value & pcorg & pcorg\_p.value & pcore & pcore\_p.value & se & sg \\ 
\hline \\[-1.8ex] 
